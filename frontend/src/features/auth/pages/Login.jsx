      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-[#0E0E0E] rounded-2xl border border-white/5 p-8 shadow-2xl backdrop-blur-sm">
          ...
          <div className="mt-6 flex gap-3">
            <button className="flex-1 py-2 px-4 rounded-lg border border-white/10 hover:border-white/20 hover:bg-white/5 transition text-on-surface text-sm font-medium flex items-center justify-center gap-2">
