...
const ChatInput = ({ onSend }) => {
    ...
    return (
        <div className='w-full flex flex-col bg-black rounded-3xl p-2 border border-neutral-700/50 focus-within: shadow-lg relative'>
            <textarea 
                ref={textareaRef}
                className='w-full bg-transparent text-neutral-100 focus:outline-none placeholder:text-neutral-400 px-3 py-2 resize-none overflow-y-auto max-h-[200px] leading-relaxed text-[15px]' 
